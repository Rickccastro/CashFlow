...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateHenderWithProfilePhotoAndName(page);
        ...
        foreach (var expense in expenses)
        {
            ...
            if(string.IsNullOrWhiteSpace(expense.Description)==false)
            {
               var descriptionRow = table.AddRow();
                ...
                descriptionRow.Cells[0].Format.Font = new Font { Name = FontHelper.NOTOSANS_REGULAR, Size = 10, Color = ColorsHelper.BLACK };
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Title = $"{ResourceReportGeneration.EXPENSE_FOR}{month.ToString("Y")}";
        document.Info.Author = "Ricardo Castro";
    ...
    private void CreateTotalSpentSection(Section page,DateOnly month, decimal totalExpenses)
    {
        ...
        var title = string.Format(ResourceReportGeneration.TOTAL_SPENT_IN, month.ToString("Y"));

        paragraph.AddFormattedText(title, new Font { Name = FontHelper.RALEWAY_REGULAR, Size = 15 });
        paragraph.AddLineBreak();

        paragraph.AddFormattedText($"{CURRENCY_SYMBOL}{totalExpenses}", new Font { Name = FontHelper.NOTOSANS_BLACK, Size = 50 }); ;
    }

    private void CreateHenderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile=Path.Combine(directoryName!, "Logo", "408455588_1405315300059944_2786159208171714085_n.jpg");
       
        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Olá,Ricardo Castro");
    ...
    {
        cell.AddParagraph(ResourceReportGeneration.AMOUNT);
    ...
    {
        cell.Format.Font = new Font { Name = FontHelper.NOTOSANS_REGULAR, Size = 12, Color = ColorsHelper.BLACK };
    ...
    private void AddAmountForExpense(Cell cell,decimal amount)
    {
        ...
        cell.Format.Font = new Font { Name = FontHelper.NOTOSANS_REGULAR, Size = 14, Color = ColorsHelper.BLACK };
